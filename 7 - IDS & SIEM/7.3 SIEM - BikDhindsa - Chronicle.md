...
* In the search bar, type `signin.office365x24.com` and click Search. Under `DOMAINS`, click signin.office365x24.com to complete the search. Below are the screenshots of the legacy view, VT, and IP address `40.100.174.34`.
  ...
  * Image 1 Legacy View
  ...
  ![Image1](https://github.com/BikDHINDSA/Cybersecurity_Portfolio/blob/main/Assets/7.3_1.png)

  * Image 2 VT 
  
  ![Image2](https://github.com/BikDHINDSA/Cybersecurity_Portfolio/blob/main/Assets/7.3_2.png)

  * Image 3 IP address `40.100.174.34`
  
  ![Image3](https://github.com/BikDHINDSA/Cybersecurity_Portfolio/blob/main/Assets/7.3_3.png)
